...
using TripShare.Models.AccountViewModels;
using TripShare.Models.ManageViewModels;
...
namespace TripShare.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Wallet()
        {
            ...
            {
                var model = new WalletViewModel { HasGeneratedWallet = true, WalletInfo = new Wallet { wif = user.Wif, address = user.Address, scriptHash = user.ScriptHash } };
                return View(model);
            }
        ...
        public async Task<IActionResult> GenerateWallet()
        {
            ...
            var wallet = await _blockchainRepository.GenerateWallet();
            if (wallet == null)
                return View();
            user.Wif = wallet.wif;
            user.Address = wallet.address;
            string s = await _blockchainRepository.GetScriptHashFromAddress(wallet.address);
            if (s == null)
                return View();
            user.ScriptHash = s;
